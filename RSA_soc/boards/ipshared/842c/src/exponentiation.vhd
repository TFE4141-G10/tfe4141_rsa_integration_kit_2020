...
begin
    ...
    last_result_out <= last_message_in;
    ----------------------------------------------------------------------------------
    ...
    begin
        ...
        if rising_edge(clk) then
            ...
            elsif last_multiplication = '1' and counter_zero = '1' then
    ...
    ----------------------------------------------------------------------------------
    message_state_machine : process(clk, message_state, valid_in, internal_valid_out, ready_out) is
    begin
        if rising_edge(clk) then
        ready_in <= '0';
