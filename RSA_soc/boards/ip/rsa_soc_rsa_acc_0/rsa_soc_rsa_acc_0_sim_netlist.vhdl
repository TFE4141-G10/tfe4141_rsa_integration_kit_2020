...
entity rsa_soc_rsa_acc_0_exponentiation is
  port (
    \FSM_sequential_message_state_reg[0]_0\ : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
    msgin_valid_vector : in STD_LOGIC_VECTOR ( 1 downto 0 );
    clk : in STD_LOGIC;
    \FSM_sequential_message_state_reg[0]_1\ : in STD_LOGIC
  );
...
architecture STRUCTURE of rsa_soc_rsa_acc_0_exponentiation is
  ...
  signal msgin_ready_vector_1 : STD_LOGIC;
  signal next_message_state : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_message_state[1]_i_1__0\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of msgin_ready_reg_i_1 : label is "soft_lutpair0";
begin
\FSM_sequential_message_state[0]_i_1__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
      I0 => message_state(0),
      I1 => msgin_valid_vector(1),
      I2 => message_state(1),
      O => next_message_state(0)
    );
\FSM_sequential_message_state[1]_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
      I0 => message_state(0),
      I1 => message_state(1),
      O => msgin_ready_vector_1
    );
\FSM_sequential_message_state_reg[0]\: unisim.vcomponents.FDPE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      PRE => \FSM_sequential_message_state_reg[0]_1\,
      Q => message_state(0)
    );
\FSM_sequential_message_state_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      ...
      C => clk,
      CE => '1',
      CLR => \FSM_sequential_message_state_reg[0]_1\,
      D => msgin_ready_vector_1,
      Q => message_state(1)
    );
msgin_ready_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0F004444"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rsa_soc_rsa_acc_0_exponentiation_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    clk : in STD_LOGIC;
    \FSM_sequential_message_state_reg[0]_0\ : in STD_LOGIC;
    msgout_ready_vector : in STD_LOGIC_VECTOR ( 0 to 0 );
    msgin_valid_vector : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rsa_soc_rsa_acc_0_exponentiation_1 : entity is "exponentiation";
end rsa_soc_rsa_acc_0_exponentiation_1;

architecture STRUCTURE of rsa_soc_rsa_acc_0_exponentiation_1 is
...
\FSM_sequential_message_state[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F4A"
    )
        port map (
      I0 => \^q\(0),
      I1 => msgout_ready_vector(0),
      I2 => \^q\(1),
      I3 => msgin_valid_vector(0),
      O => next_message_state(0)
    );
\FSM_sequential_message_state[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\FSM_sequential_message_state_reg[0]\: unisim.vcomponents.FDPE
    generic map(
      ...
      CE => '1',
      D => next_message_state(0),
      PRE => \FSM_sequential_message_state_reg[0]_0\,
      Q => \^q\(0)
    );
\FSM_sequential_message_state_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      ...
      C => clk,
      CE => '1',
      CLR => \FSM_sequential_message_state_reg[0]_0\,
...
entity rsa_soc_rsa_acc_0_rsa_msgin is
  port (
    ...
    CLK : out STD_LOGIC;
    \^clk\ : in STD_LOGIC;
    \msgbuf_slot_valid_r_reg[6]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of rsa_soc_rsa_acc_0_rsa_msgin is
  ...
  signal \msgbuf_slot_valid_r[7]_i_3_n_0\ : STD_LOGIC;
...
\msgbuf_slot_valid_r[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BF00FF00FF00FF00"
        ...
        port map (
      I0 => \msgbuf_slot_valid_r[7]_i_3_n_0\,
      I1 => \msgbuf_slot_valid_r_reg_n_0_[6]\,
...
\msgbuf_slot_valid_r[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\msgin_valid_vector[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00008000"
    )
        port map (
...
architecture STRUCTURE of rsa_soc_rsa_acc_0_rsa_regio is
  ...
  signal \generate_cores[1].u_rsa_core/i_exponentiation/double_multiplication_done0\ : STD_LOGIC;
...
\axi_rdata[31]_i_15\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \generate_cores[1].u_rsa_core/i_exponentiation/double_multiplication_done0\,
      I1 => key_e_d(223),
      I2 => sel0(1),
      I3 => key_e_d(191),
      I4 => sel0(0),
...
\slv_reg_reg[15][31]\: unisim.vcomponents.FDRE
     port map (
      ...
      CE => \slv_reg[15][31]_i_1_n_0\,
      D => s00_axi_wdata(31),
      Q => \generate_cores[1].u_rsa_core/i_exponentiation/double_multiplication_done0\,
      R => \^reset_n_0\
    );
...
entity rsa_soc_rsa_acc_0_rsa_core is
  port (
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    clk : in STD_LOGIC;
    \FSM_sequential_message_state_reg[0]\ : in STD_LOGIC;
    msgout_ready_vector : in STD_LOGIC_VECTOR ( 0 to 0 );
    msgin_valid_vector : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
...
begin
i_exponentiation: entity work.rsa_soc_rsa_acc_0_exponentiation_1
     port map (
      \FSM_sequential_message_state_reg[0]_0\ => \FSM_sequential_message_state_reg[0]\,
      Q(1 downto 0) => Q(1 downto 0),
      clk => clk,
      msgin_valid_vector(0) => msgin_valid_vector(0),
      msgout_ready_vector(0) => msgout_ready_vector(0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rsa_soc_rsa_acc_0_rsa_core_0 is
  port (
    \FSM_sequential_message_state_reg[0]\ : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
    msgin_valid_vector : in STD_LOGIC_VECTOR ( 1 downto 0 );
    clk : in STD_LOGIC;
    \FSM_sequential_message_state_reg[0]_0\ : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rsa_soc_rsa_acc_0_rsa_core_0 : entity is "rsa_core";
end rsa_soc_rsa_acc_0_rsa_core_0;

architecture STRUCTURE of rsa_soc_rsa_acc_0_rsa_core_0 is
begin
i_exponentiation: entity work.rsa_soc_rsa_acc_0_exponentiation
     port map (
      ...
      Q(1 downto 0) => Q(1 downto 0),
      clk => clk,
      msgin_valid_vector(1 downto 0) => msgin_valid_vector(1 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of rsa_soc_rsa_acc_0_rsa_accelerator is
  ...
  signal \generate_cores[1].u_rsa_core_n_0\ : STD_LOGIC;
  signal \i_exponentiation/message_state\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal msgin_ready : STD_LOGIC;
  signal msgin_ready_reg_i_2_n_0 : STD_LOGIC;
  signal msgin_valid : STD_LOGIC;
  signal msgout_ready_vector : STD_LOGIC_VECTOR ( 0 to 0 );
  signal p_1_in : STD_LOGIC;
  signal u_rsa_regio_n_1 : STD_LOGIC;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of msgin_ready_reg : label is "LD";
begin
...
\generate_cores[0].u_rsa_core\: entity work.rsa_soc_rsa_acc_0_rsa_core
     port map (
      \FSM_sequential_message_state_reg[0]\ => u_rsa_regio_n_1,
      Q(1 downto 0) => \i_exponentiation/message_state\(1 downto 0),
      clk => clk,
      msgin_valid_vector(0) => SHIFT_LEFT(1),
      msgout_ready_vector(0) => msgout_ready_vector(0)
    );
\generate_cores[1].u_rsa_core\: entity work.rsa_soc_rsa_acc_0_rsa_core_0
     port map (
      \FSM_sequential_message_state_reg[0]\ => \generate_cores[1].u_rsa_core_n_0\,
      \FSM_sequential_message_state_reg[0]_0\ => u_rsa_regio_n_1,
      Q(1 downto 0) => \i_exponentiation/message_state\(1 downto 0),
      clk => clk,
      msgin_valid_vector(1) => p_1_in,
      msgin_valid_vector(0) => SHIFT_LEFT(1)
    );
msgin_ready_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => \generate_cores[1].u_rsa_core_n_0\,
      G => msgin_ready_reg_i_2_n_0,
      GE => '1',
      Q => msgin_ready
    );
msgin_ready_reg_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => SHIFT_LEFT(1),
      I1 => p_1_in,
      O => msgin_ready_reg_i_2_n_0
    );
\msgin_valid_vector_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1',
      IS_C_INVERTED => '1'
    )
...
\msgin_valid_vector_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\msgout_ready_vector_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
u_rsa_msgin: entity work.rsa_soc_rsa_acc_0_rsa_msgin
     port map (
      CLK => msgin_valid,
      \^clk\ => clk,
      \msgbuf_slot_valid_r_reg[6]_0\ => u_rsa_regio_n_1,
